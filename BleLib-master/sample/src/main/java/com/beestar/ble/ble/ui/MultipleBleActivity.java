...
import com.beestar.ble.ble.greendao.CommonUtils;
...
public class MultipleBleActivity extends AppCompatActivity {
                ...
                if (status==gatt.GATT_SUCCESS){
                    ...
                    for (int i = 0; i < services.size(); i++) {
                        ...
                        if (services.get(i).getUuid().toString().contains("ffe5")) {
                            ...
                            characteristics_uuid_write = services.get(i).getCharacteristics().get(0).getUuid().toString();
                        ...
                        if (services.get(i).getUuid().toString().contains("ffe0")) {
                            ...
                            characteristics_uuid_read = services.get(i).getCharacteristics().get(0).getUuid().toString();
    ...
    public void onClick_getdata(View view) {
        List<Equipment_Device> equipment_devices = commonUtils.listAll();
        getdata.setText(equipment_devices.get(0).getAddress());
    }
}
